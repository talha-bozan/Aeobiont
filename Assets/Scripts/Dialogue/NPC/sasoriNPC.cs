...
public class sasoriNPC : MonoBehaviour
{
    [SerializeField]
    ...
    public void button()
    {
        string pokemonName = ((Ink.Runtime.StringValue)DialogueManager
            .GetInstance()
            .GetVariableState("choice_name_sasori")).value;
        ...
        switch (pokemonName)
        {
            ...
            case "friendly10":
                if (currentFriendly < 90)
                {
                    ...
                    Debug.Log("current friendly of sasori = " + currentFriendly);
    ...
    public void deletion()
    {
        ((Ink.Runtime.StringValue)DialogueManager
            .GetInstance()
            .GetVariableState("choice_name_sasori")).value = "empty";
    }
}
