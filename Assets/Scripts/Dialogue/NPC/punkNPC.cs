...
public class punkNPC : MonoBehaviour
{
    public NeedManager player; // for needs
    ...
    public void button()
    {
        ...
        string pokemonName = ((Ink.Runtime.StringValue)DialogueManager
            .GetInstance()
            .GetVariableState("choice_name_Punk")).value;
    ...
    public void deletion()
    {
        ((Ink.Runtime.StringValue)DialogueManager
            .GetInstance()
            .GetVariableState("choice_name_Punk")).value = "empty";
    }
}
